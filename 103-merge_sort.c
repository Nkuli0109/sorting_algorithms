...
/**
 * merge - make a merge
 * @arr: from start to middle
 * @tmp: array used to merge, created outside to
 * optimize reducing the system calls
 * @start: first element position
 * @mid: array middle
 * @end: last position of element
 **/
...
/**
 * mergesort - sorts ana array of integers
 * in ascending order using the Merge sort algorithm
 * @array: array of integers
 * @tmp: temp array used to merge, was created outside to
 * optomize reducing the sysytem calls
 * @start: first element position
